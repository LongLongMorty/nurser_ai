<template>
  <div class="outing-apply">
    ...
    <el-dialog
      ...
      :title="`${selectedCustomer?.customerName || ''} - 外出申请`"
      width="600px"
    ...
    >
      ...
      >
        ...
        <el-form-item label="紧急联系人" prop="emergencyContact">
          <el-input v-model="applyForm.emergencyContact" placeholder="请输入紧急联系人姓名" />
        </el-form-item>

        <el-form-item label="联系电话" prop="emergencyPhone">
          <el-input v-model="applyForm.emergencyPhone" placeholder="请输入联系电话" />
        </el-form-item>
    ...
    <el-dialog
      ...
      :title="`${selectedRecordCustomer?.customerName || ''} - 外出记录`"
      width="1200px"
      :close-on-click-modal="false"
    >
      <div class="records-dialog-content">
          ...
          <el-form :model="recordsQueryForm" inline>
            <el-form-item label="申请时间">
              <el-date-picker
                ...
                @change="loadOutingRecords"
                style="width: 280px"
              />
            </el-form-item>
            <el-form-item label="状态">
              <el-select v-model="recordsQueryForm.status" placeholder="请选择状态" @change="loadOutingRecords" style="width: 120px">
        ...
        >
          ...
          <el-table-column prop="emergencyContact" label="紧急联系人" width="100" align="center" />
          <el-table-column prop="emergencyPhone" label="联系电话" width="120" align="center" />
          ...
          <el-table-column label="操作" width="120" align="center" fixed="right">
            <template #default="{ row }">
              <el-button
                v-if="row.applyStatus === 'APPROVED' && !row.actualReturnDate"
                type="success"
                size="small"
              ...
              <span v-else-if="row.actualReturnDate">已回院</span>
              <span v-else>{{ getApplyStatusText(row.applyStatus) }}</span>
            </template>
          </el-table-column>
        </el-table>
...
import { submitOutingApply, getMyOutingApplies, registerReturn as apiRegisterReturn, type OutingApply, type OutingApplyDTO, type OutingReturnDTO } from '@/api/apply'
...
const submitApply = async () => {
  ...
  try {
    const data: OutingApplyDTO = {
      ...
      emergencyContact: applyForm.emergencyContact,
